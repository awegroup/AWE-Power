function computePower_awePower(i,inputs)
  % computePower_awePower Computes the power generated by a fixed-wing
  % airborne wind energy system
  %
  % This function computes various parameters and power during both the reel-out 
  % and reel-in phases of operation. The calculations are based on the given inputs
  % and are stored in the global 'outputs' structure.
  %
  % Inputs:
  %   i       - Wind speed at current iteration
  %   inputs  - Structure containing necessary input parameters and constants
  %
  % Note:
  %   The function updates the global 'outputs' structure with computed values.
