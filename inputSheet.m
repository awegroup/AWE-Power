...
inputs.x0     = [200,    deg2rad(20), deg2rad(5),    200,       inputs.v_d_max*nx, inputs.Cl_maxAirfoil*inputs.Cl_eff_F*nx, 0.5*nx, 200*nx,           inputs.Cl_maxAirfoil*inputs.Cl_eff_F*nx];
...
inputs.lb     = [50,   deg2rad(1),  deg2rad(1),  70,  1*nx, 0.1*nx, 0.2*nx, 1*nx, 0.1*nx]; % 
inputs.ub     = [500,  deg2rad(90), deg2rad(60), 300, inputs.v_d_max*nx, inputs.Cl_maxAirfoil*inputs.Cl_eff_F*nx, inputs.v_d_max*nx,  200*nx,inputs.Cl_maxAirfoil*inputs.Cl_eff_F*nx]; %
