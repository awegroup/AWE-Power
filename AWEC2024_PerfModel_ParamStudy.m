...
for i = 1:numEvals
    plot(inputs.vw_ref,wingArea_sens(i).P_e_avg./1e6,'o-','linewidth',1,'MarkerSize',2);
...
legendLabels = cell(numEvals,1);
for i = 1:numEvals
    plot(inputs.vw_ref,Ft_max_sens(i).P_e_avg./1e6,'o-','linewidth',1,'MarkerSize',2);
...
legendLabels = cell(numEvals,1);
for i = 1:numEvals
    plot(inputs.vw_ref,Cd_t_sens(i).P_e_avg./1e6,'o-','linewidth',1,'MarkerSize',2);
...
legendLabels = cell(numEvals,1);
for i = 1:numEvals
    plot(inputs.vw_ref,CL_sens(i).P_e_avg./1e6,'o-','linewidth',1,'MarkerSize',2);
...
legendLabels = cell(numEvals,1);
for i = 1:numEvals
    plot(inputs.vw_ref,Gen_sens(i).P_e_avg./1e6,'o-','linewidth',1,'MarkerSize',2);
...
legendLabels = cell(numEvals,1);
for i = 1:numEvals
    plot(inputs.vw_ref,mk_sens(i).P_e_avg./1e6,'o-','linewidth',1,'MarkerSize',2);
...
legendLabels = cell(numEvals,1);
for i = 1:numEvals
    plot(inputs.vw_ref,windShear_sens(i).P_e_avg./1e6,'o-','linewidth',1,'MarkerSize',2);
    legendLabels{i} = ['Wind shear coeff. = ' num2str(windShear(i))];
end
title(strcat('S = ',num2str(inputs.S),'m^2'));
subplot1Formatting(processedOutputs.vw_100m_operRange(end), 2.5, legendLabels);
hold off
...
box on
for i = 1:numEvals
  scatter(windShear(i),windShear_sens_AEP(i),100, "filled");
end
subplot2Formatting(windShear,windShear_sens_AEP,'Wind shear coeff. (-)','(%)');
hold off
