...
%Logging information
loggerID = 'QSMlogger';
logger = mlog.Logger(loggerID,'QSMlogger_pumpingFixed.log');
logger.clearLog();
logger.CommandWindowThreshold = "INFO";

% Load input file
inputs = loadInputs('inputFile_example_Class_pumpingFixed.yml');

% Run
[inputs, outputs, optimDetails, processedOutputs, simulationQSM] = main_Class_pumpingFixed(inputs, loggerID);
